...
export default function Header({ token }: CommonProps) {
  ...
  return (
    <>
      <div className="padding-top: env(safe-area-inset-top); hidden h-[5.625rem] bg-white px-10 py-8 sm:flex">
        <Link href="/">
          <Image
      ...
      {/* 모바일 화면 */}
      <div className="padding-top: env(safe-area-inset-top); flex h-16 items-center justify-between bg-white px-5 py-[0.875rem] text-center sm:hidden">
