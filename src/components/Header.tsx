...
export default function Header({ token }: CommonProps) {
  ...
  return (
    <>
      ...
      {/* 모바일 화면 */}
      <div className="absolute left-0 top-[env(safe-area-inset-top)] z-10 flex h-16 w-full items-center justify-between bg-white px-5 py-[0.875rem] text-center sm:hidden">
