...
export default function Calendar() {
  return (
    <div className="grow shrink basis-0 flex-col justify-start items-center gap-10 inline-flex">
      ...
      <div className="self-stretch h-[385px] flex-col justify-start items-center gap-4 flex">
        <div className="self-stretch h-[385px] rounded-[10px] flex-col justify-start items-center gap-5 flex">
          <div className="self-stretch justify-between items-center inline-flex">
            <div className="w-5 h-5 p-2 justify-center items-center flex" />
            <div className="text-grey-500 text-2xl font-semibold">4월</div>
          ...
          <div className="h-[13px] px-[3px] justify-start items-center gap-1 inline-flex">
            ...
            <div className="justify-center items-center gap-2.5 flex">
              <div className="text-grey-500 text-base font-bold">주중 나눔 가능</div>
            </div>
          </div>
            ...
            <div className="self-stretch justify-between items-start inline-flex">
              {dayOfWeekOption.map(day => (
                <div key={day} className="h-[33px] px-2 py-[5px] rounded-full justify-center items-center gap-2.5 flex">
                  <div className="text-center text-grey-800 text-base font-semibold">{day}</div>
                </div>
              ))}
            </div>
            <div className="self-stretch justify-between items-start inline-flex">
              {dateOptions.map(date => (
                <div key={date} className="h-[31px] px-2 py-1 rounded justify-center items-center gap-2.5 flex">
                  <div className="text-center text-grey-500 text-base font-semibold">{date}</div>
                </div>
              ))}
            </div>
          </div>
          <div className="relative w-[432px] h-52 bg-black/5 rounded-[10px]">
