...
export default function SignIn() {
  ...
  return (
    <div className={`${!isOpen && 'hidden'} fixed w-screen h-screen flex justify-center items-center`}>
      <div className="rounded-[20px] max-w-[474px] max-h-[630px] w-full md:h-full h-[551px] mx-[30px] bg-black bg-opacity-70 text-gray-200">
