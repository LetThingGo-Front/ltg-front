...
export default function SignIn() {
  ...
  return (
    <div
      className={`${!isOpen && "hidden"} fixed bottom-[env(safe-area-inset-bottom)] left-0 top-[env(safe-area-inset-top)] z-30 flex h-full w-full items-center justify-center backdrop-blur-xl`}
    >
