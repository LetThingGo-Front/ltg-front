...
export default function SignIn() {
  ...
  return (
    <div
      className={`${!isOpen && "hidden"} fixed left-0 top-[env(safe-area-inset-top)] z-30 flex h-full max-h-[calc(100%-env(safe-area-inset-top))] w-full items-center justify-center backdrop-blur-xl`}
    >
