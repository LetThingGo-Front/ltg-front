...
export default function LandingModal() {
  return (
    <div
      className="fixed left-1/2 transform -translate-x-1/2 p-7 rounded-xl backdrop-blur-lg bg-white/40"
      style={{ top: '150px', width: '540px', height: '650px' }}
    >
      <div className="text-center">
        <div className="flex justify-center">
          <Image src="/images/landing.png" alt="langing-image" width={95} height={123} />{' '}
        </div>
        <div className="mt-5">
          <p className="font-bold text-xl mb-1">Let your things go</p>
          <p className="font-bold text-lg">묵혀두지 말고 보내주세요</p>
        </div>
      </div>
      <div className="text-center mt-7">
        <p className="text-sm">서울에서 나눔 가능한 물품</p>
        <p className="font-bold text-4xl text-stone-600">1000건</p>
      </div>
      <div className="text-center mt-7">
        <input
          type="text"
      ...
      <div className="flex justify-center">
        <div className="mt-6">
          <div className="text-center">
            <button className="w-64 px-5 py-2 flex items-center bg-white rounded-full shadow-lg">
